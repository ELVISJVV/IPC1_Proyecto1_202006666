...
public class Principal {
    ...
    public static void main(String[] args) {
     ...
     ventanaInicio.setVisible(true);
        ...
        CargaIndividual ventanaCarga = new CargaIndividual();
        //  ventanaCarga.setVisible(true);

        CargaIndividualRevista ventana = new CargaIndividualRevista();
        // ventana.setVisible(false);

        CrearBibliografia biblio = new CrearBibliografia();
