 ...
 * @author Elvis
 */
public class CargaIndividualTesis extends JFrame  implements ItemListener{
...
public CargaIndividualTesis(){
     setTitle("                                                                                                                                     CARGA INDIVIDUAL TESIS ");
...
/*
     ...
     public void itemStateChanged(ItemEvent e) {
          ...
          CargaIndividualTesis ventanaTesis = new CargaIndividualTesis();
           ...
           if (e.getSource()==listadespegable1) {
      ...
      ventanaTesis.setVisible(false);
       ...
       ventanaLibro.setVisible(true);
                ...
                dispose();
            } else if (seleccionado.equals("Revista")){
                   ventanaTesis.setVisible(false);
